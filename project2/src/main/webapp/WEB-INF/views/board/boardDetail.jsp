...
<body>
        ...
        <section class="board-detail">  
            ...
            <c:if test="${not empty thumbnail}">
                ...
                <div class="img-box">
                    <div class="boardImg thumbnail">
                        ...
                        download="${thumbnail.imageReName}">다운로드</a>         
                    </div>
                </div>
            </c:if>
            ...
            <c:if test="${not empty thumbnail}"> <%-- 썸네일 O --%>
                <c:set var="start" value="1" />
                    ...
                    <%-- imageList의 이미지 개수가 start 보다 클 경우 
    ...
    <%-- JSP 내장 객체에 세팅 값을 JS에 얻어가는 방법 1 --%>
    <%-- - 화면에 숨겨놓고 JS를 이용해서 값을 얻어가는 방법 --%>
    <%-- <input type="hidden" name="memberNo" value="${loginMember.memberNo}"> --%>

    <%-- JSP 내장 객체에 세팅 값을 JS에 얻어가는 방법 2 --%>
